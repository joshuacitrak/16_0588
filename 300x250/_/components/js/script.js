function startAd(){  
    ...
    dtl.from("#d1", .6, {scale:0, opacity:0, ease: Back.easeOut.config(1)})
    .to("#d1", 1, {x:-240, ease: Power3.easeOut}, 2)
    .from("#d2", 1, {opacity:0, x: 350, ease: Power3.easeOut}, 2)
    .from("#dna3", .6, {opacity:0, ease: Power3.easeOut}, 2.8);
