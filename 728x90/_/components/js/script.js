function startAd(){  
   var ttl = new TimelineLite();
    ttl.from("#t1", .8, { opacity:0, ease: Power3.easeOut})
        ...
        .to("#t1a", 1, {scale:2, x:-1200, ease: Power3.easeOut}, 6)
        .to("#t1b", 1, {scale:4, x:-800, ease: Power3.easeOut }, 6)
        .to("#t1c", 1, {css:{z:430, x:-29},  ease: Power3.easeOut}, 6)
        .to("#t1c", 1, {opacity:0, ease: Power3.easeOut}, 6.5);
